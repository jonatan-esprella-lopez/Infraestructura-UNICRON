...
export const roleRoutes: RoleRoute[] = [
  ...
  { key: ModuleKey.ProptechProperties, label: 'Propiedades', path: ROUTES.proptechProperties, icon: Building2, featureFlag: 'proptech', permissions: [Permission.PropPropertyRead], roles: [Role.Admin, Role.Manager, Role.AgencyAdmin, Role.Agent, Role.Owner] },
